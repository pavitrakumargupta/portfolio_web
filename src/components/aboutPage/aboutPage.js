        ...
        <div className='field'>
            ...
            <img src={profile} alt="" />
             <p>Hi, I'm  Pavitra Kumar Gupta , a full-stack developer with 1 years of experience building dynamic, user-friendly web applications. I have a passion for coding and love to take complex problems and turn them into intuitive and elegant solutions.
              With a strong background in React.js, Node.js, MongoDB, Javascript, HTML ,CSS , I am proficient in both front-end and back-end development. I am comfortable working with a variety of technologies, including Bootstrap, TailWind, Git, REST APIs, AWS, Firebase, Heroku, Netlify.
              ...
              When I am not coding, I enjoy  reading books music and specially workout. <br />
